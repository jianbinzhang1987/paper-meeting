...
@Component
public class MeetingForceLogoutMessageListener implements WebSocketMessageListener<MeetingWsControlPayload> {
    ...
    public void onMessage(WebSocketSession session, MeetingWsControlPayload message) {
        ...
        meetingWebSocketSender.sendForceLogout(message);
    }

    @Override
    public String getType() {
        return MeetingWebSocketMessageType.CLIENT_FORCE_LOGOUT_SEND;
    }
